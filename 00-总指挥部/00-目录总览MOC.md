...
### AI读取入口（4个S级入口文件，全部位于 04-AI路由与入口/00-AI读取入口/）

| 文件 | 一句话用途 |
|------|-----------|
| [[00-总指挥部/04-AI路由与入口/00-AI读取入口/08-claude-mem记忆规则]] | claude-mem 只做项目断点续工，不做全量聊天记录仓库 |
| [[00-总指挥部/04-AI路由与入口/00-AI读取入口/09-Codex总指挥规则]] | Codex 是总指挥，规划、拆解、风控、验收，不做执行苦力 |
| [[00-总指挥部/04-AI路由与入口/00-AI读取入口/10-ClaudeCode执行规则]] | Claude Code 是执行者，按 Codex 规划执行，小步快跑 |
| [[00-总指挥部/04-AI路由与入口/00-AI读取入口/11-知识质量判断标准]] | 判断知识库内容质量等级（S/A/B/C），决定引用优先级 |

### 治理规则文件（3个S级，位于 04-AI路由与入口/）

| 文件 | 一句话用途 |
|------|-----------|
| [[00-总指挥部/04-AI路由与入口/12-信息进入知识库SOP]] | 新信息进入知识库的标准流程和筛选规则 |
| [[00-总指挥部/04-AI路由与入口/13-噪音与垃圾信息处理规则]] | 判断并处理低价值信息的规则 |
| [[00-总指挥部/04-AI路由与入口/14-人的审判规则]] | AI处理不了的问题交给人的审判标准 |

### 其他S级文件

| 文件 | 一句话用途 |
|------|-----------|
| [[00-总指挥部/04-AI路由与入口/15-个人微信与OpenClaw连接说明]] | 个人微信与OpenClaw的连接配置说明 |
...
全库18个工作类型MOC，通过 [[00-总指挥部/MOC/01-全库工作总览MOC]] 可以找到全部入口。以下是18个MOC的快速索引：

| # | MOC名称 | 所在路径 |
|---|---------|---------|
| 01 | [[MOC/01-全库工作总览MOC]] | 00-总指挥部/MOC/ |
| 02 | [[MOC/02-AI读取入口MOC]] | 00-总指挥部/MOC/ |
| 03 | [[MOC/03-外贸市场情报MOC]] | 00-总指挥部/MOC/ |
| 04 | [[MOC/04-跨境社媒获客MOC]] | 00-总指挥部/MOC/ |
| 05 | [[MOC/05-广告投流增长MOC]] | 00-总指挥部/MOC/ |
| 06 | [[MOC/06-内容素材创意MOC]] | 00-总指挥部/MOC/ |
| 07 | [[MOC/07-客户开发成交MOC]] | 00-总指挥部/MOC/ |
| 08 | [[MOC/08-客户沟通复盘MOC]] | 00-总指挥部/MOC/ |
| 09 | [[MOC/09-工厂探访评估MOC]] | 00-总指挥部/MOC/ |
| 10 | [[MOC/10-食品机械作战MOC]] | 00-总指挥部/MOC/ |
| 11 | [[MOC/11-选品产品研究MOC]] | 00-总指挥部/MOC/ |
| 12 | [[MOC/12-行业竞品案例MOC]] | 00-总指挥部/MOC/ |
| 13 | [[MOC/13-国内业务代运营MOC]] | 00-总指挥部/MOC/ |
| 14 | [[MOC/14-AI工具自动化MOC]] | 00-总指挥部/MOC/ |
| 15 | [[MOC/15-财务账单分析MOC]] | 00-总指挥部/MOC/ |
| 16 | [[MOC/16-学习成长蒸馏MOC]] | 00-总指挥部/MOC/ |
| 17 | [[MOC/17-资料下载归档MOC]] | 00-总指挥部/MOC/ |
| 18 | [[MOC/18-成交案例战报MOC]] | 00-总指挥部/MOC/ |
